...
layer1Weight = createWeight(100, 60)
layer2Weight = createWeight(60, 60)
layer3Weight = createWeight(60, 9)
layer1Bias = createBias(60)
layer2Bias = createBias(60)
layer3Bias = createBias(9)
...
# derivation
gradientHiddenLayer3 = [0] * 60
gradientHiddenLayer2 = [0] * 60
...
for epoch in range(4500):
    ...
    for number in range(1, 10):
        for case in range(1, 11):
            ...
            input = flaten(input)
            HiddenLayer1 = fullyConnected(input, layer1Weight, layer1Bias, 60)
            HiddenLayer1 = activationFunction(HiddenLayer1, "sigmoid")
            HiddenLayer2 = fullyConnected(HiddenLayer1, layer2Weight, layer2Bias, 60)
            HiddenLayer2 = activationFunction(HiddenLayer2, "sigmoid")
            finalLayer = fullyConnected(HiddenLayer2, layer3Weight, layer3Bias, 9)
